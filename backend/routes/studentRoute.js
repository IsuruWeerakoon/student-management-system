...
router.get('/students', authenticateUser, authorizeAdmin, function (req, res) {
...
router.get('/students/record', authenticateUser, function (req, res) {
...
router.post('/students', authenticateUser, authorizeAdmin, upload, async function (req, res) {
...
router.get('/students/search', authenticateUser, authorizeAdmin, function (req, res) {
...
router.put('/students/:id', authenticateUser, upload, function (req, res) {
    const studentID = req.params.id;
    if (req.file === undefined) {
...
router.post('/students/account/:id', authenticateUser, async function (req, res) {
...
router.delete('/students/:id', authenticateUser, authorizeAdmin, function (req, res) {
    const studentID = req.params.id;
    studentModel.retrieveByID(studentID, function (err, data) {
        if (err) {
            console.log(err);
